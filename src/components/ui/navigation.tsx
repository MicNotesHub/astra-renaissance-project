...
const navItems = [
  { name: "Elezioni 2025", href: "#elezioni", isExternal: false },
  { name: "Rappresentanti", href: "#team", isExternal: false },
  { name: "Dispense", href: "/dispense", isExternal: false },
  { name: "Exchange", href: "#astra-polare", isExternal: false },
  { name: "Rubrica", href: "#marketplace", isExternal: false },
            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div className="hidden sm:block">
                <span className={cn(
                  ...
                  isOnWhitePage ? "text-foreground" : "text-white"
                )}>
                  ASTRA
                </span>
                <span className={cn(
                  "text-sm font-medium ml-1 transition-colors duration-200",
                  isOnWhitePage ? "text-muted-foreground" : "text-white/70"
                )}>
                  Bocconi
                </span>
              </div>
            ...
            <div className="flex items-center space-x-1">
              ...
              >
                <Button 
                  ...
                  className="ml-4 bg-primary hover:bg-primary/90 text-white font-medium px-4 py-2 rounded-full text-sm transition-all duration-200 hover:scale-105 hover:shadow-lg"
                >
            ...
            >
              ...
              >
                {navItems.map((item, index) => (
                  ...
                  >
                    {item.href.startsWith('/') ? (
                      ...
                      <a
                        href={item.href}
                        className="flex items-center px-3 py-3 rounded-lg text-sm font-medium text-foreground/80 hover:text-foreground hover:bg-muted/50 transition-all duration-200"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
                        {item.name}
                        {item.isExternal && <ExternalLink className="h-3 w-3 ml-1" />}
                ...
                >
                  <Button 
                    onClick={handleContactClick}
                    className="w-full bg-primary hover:bg-primary/90 text-white font-medium py-3 rounded-lg text-sm transition-all duration-200"
                  >
                    <Mail className="h-4 w-4 mr-2" />
                    Contattaci
                  </Button>
