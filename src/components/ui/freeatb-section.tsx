        ...
        >
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="text-center p-6 hover:shadow-glow transition-all duration-300 rounded-2xl border-none"
                style={{ backgroundColor: '#E8F5E9' }}
              >
                <div className="w-14 h-14 bg-green-600/20 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md">
          ...
          <Card className="overflow-hidden border-none">
            ...
            >
              <div className="max-w-3xl mx-auto">
                ...
                <Button
                  size="lg"
                  className="bg-white text-green-800 hover:bg-white/90 flex items-center gap-2 mx-auto px-8 py-6 text-xl rounded-3xl"
